        ...
        <div class="blog-title-area">
            <ol class="breadcrumb hidden-xs-down">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('detail.category', ['slug' => $post->category->slug]) }}">
                        {{ $post->category->title }}</a>
                </li>
                <li class="breadcrumb-item active">{{ $post->title }}</li>
            </ol>

            <span class="color-yellow"><a href="{{ route('detail.category', ['slug' => $post->category->slug]) }}"
            ...
            @if($post->tags->count())
                <div class="tag-cloud-single">
                    ...
                    @foreach($post->tags as $tag)
                        <small><a href="{{ route('detail.tag', ['slug'=> $tag->slug]) }}" title="">{{$tag->title}}</a></small>
                    @endforeach
                </div>
            @endif
